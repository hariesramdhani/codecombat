module.exports = nativeDescription: "Bahasa Indonesia", englishDescription: "Indonesian", translation:
  new_home:
    slogan: "Game untuk belajar pemograman paling menyenangkan."
...
#    setup_a_class: "Set Up a Class"
    ...
    courses_available_in: "Kursus tersedia dalam JavaScript, Python, dan Java (segera hadir!)" # {change}
...
#    faqs: "FAQs"
    ...
    help_suff: "Dan kami akan menghubungi!"
#    resource_hub: "Resource Hub"
  ...
  play:
    ...
    subscribers_only: "Hanya untuk Pelanggan!"
    subscribe_unlock: "Berlangganan untuk membuka!"
    subscriber_heroes: "Berlangganan hari ini untuk membuka Amara, Hushbaum, and Hattori!"
    subscriber_gems: "Berlangganan hari ini untuk membeli pahlawan ini dengan gems!"
    ...
    brain_pop_done: "Kamu berhasil mengalahkan raksasanya dengan kode! Kamu menang!"
    brain_pop_challenge: "Tantang dirimu untuk bermain lagi menggunakan bahasa pemrogaman yang berbeda!"
    replay: "Main lagi"
    back_to_classroom: "Kembali ke ruang kelas"
 ...
 code:
  ...
  login:
    ...
    authenticate_gplus: "Otentikasi dengan Google"
    load_profile: "Memuat Profil Google"
    finishing: "Finishing"
 ...
 signup:
   create_student_header: "Buat Akun Pelajar"
   create_teacher_header: "Buat Akun Guru"
   create_individual_header: "Buat Akun Pribadi"
   email_announcements: "Terima pegumuman tentang level dan fitur CodeCombat yang baru!"
   creating: "Membuat Akun..."
   sign_up: "Daftar Baru"
   log_in: "Masuk dengan password"
   required: "Anda perlu masuk sebelum anda melakukan hal tersebut."
   login_switch: "Sudah memiliki akun?"
   school_name: "Nama Sekolah dan Kota"
   optional: "opsional"
   school_name_placeholder: "Contoh SMA, Springfield, IL"
   connected_gplus_header: "Anda telah berhasil terkoneksi dengan Google+"
   connected_gplus_p: "Selesaikan pendaftaran sehingga Anda dapat masuk dengan akun Google+ Anda."
   gplus_exists: "Anda sudah memiliki akun yang terkait dengan Google+!"
   connected_facebook_header: "Anda telah berhasil terhubung dengan Facebook!"
   connected_facebook_p: "Selesaikan pendaftaran sehingga Anda bisa masuk dengan akun Facebook Anda."
   facebook_exists: "Anda sudah memiliki akun terkait dengan Facebook!"
   hey_students: "Siswa, masukan kode kelas dari guru Anda"
